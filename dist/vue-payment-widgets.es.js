    ...
    (function(p, l) {
      ...
      if (typeof browser > "u" || Object.getPrototypeOf(browser) !== Object.prototype) {
        const l = "The message port closed before a response was received.", c = "Returning a Promise is the preferred way to send a reply from an onMessage/onMessageExternal listener, as the sendResponse will be removed from the specs (See https://developer.mozilla.org/docs/Mozilla/Add-ons/WebExtensions/API/runtime/onMessage)", L = (m) => {
          ...
          const a = (t) => t && typeof t == "object" && typeof t.then == "function", y = (t, r) => (...i) => {
            ...
            return new Promise((C, P) => {
              ...
              else r.noCallback ? (u[t](...w), C()) : u[t](...w, y({
                resolve: C,
                reject: P
              }, r));
            });
...
`;
  ...
  async function T() {
    ...
    for (var [r, i] of Object.entries(b))
      i && i.match && i.match(y) && (i = new Date(i)), t[r] = i;
...
const Ae = ({ extensionId: s } = {}) => {
...
}, fe = /* @__PURE__ */ Symbol("payment-service"), Ke = {
  install: (s, x = {}) => {
    const p = Ae(x);
    s.provide(fe, p), s.config.globalProperties.$paymentService = p, x.autoStart !== !1 && p.start();
  }
}, ye = { class: "rounded-xl border border-gray-200 p-4" }, xe = { class: "grid grid-cols-2 gap-2" }, be = { class: "text-gray-800 font-medium" }, he = { class: "text-gray-800 font-medium text-sm" }, we = { class: "text-gray-800 font-medium" }, ve = { class: "text-gray-800 font-medium" }, ke = { class: "mt-6 pt-6 border-gray-200" }, Se = { class: "grid grid-cols-1 gap-4" }, _e = {
  key: 0,
        ...
        o("div", Se, [
          o("div", null, [
            ...
            R(o("input", {
              type: "text",
              id: "name",
              "onUpdate:modelValue": a[0] || (a[0] = (y) => c.value.name = y),
              class: S([
                `${s.inputClass}`,
                f(m).name.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
              ]),
              required: ""
            }, null, 2), [
              [V, c.value.name]
            ]),
            f(m).name.$error ? (v(), k("div", _e, [
              f(m).name.required.$invalid ? (v(), k("span", Ce, "Name ist erforderlich")) : f(m).name.minLength.$invalid ? (v(), k("span", Pe, "Name muss mindestens 2 Zeichen haben")) : q("", !0)
            ])) : q("", !0)
          ]),
          o("div", null, [
            o("label", {
            ...
            R(o("input", {
              type: "text",
              id: "vatId",
              "onUpdate:modelValue": a[1] || (a[1] = (y) => c.value.vatId = y),
          ...
          o("div", null, [
            ...
            R(o("input", {
              type: "text",
              id: "line1",
              "onUpdate:modelValue": a[2] || (a[2] = (y) => c.value.line1 = y),
              class: S([
                `${s.inputClass}`,
                f(m).line1.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
              ]),
              required: ""
            }, null, 2), [
              [V, c.value.line1]
            ]),
            f(m).line1.$error ? (v(), k("div", $e, [
              f(m).line1.required.$invalid ? (v(), k("span", Ee, "Adresse ist erforderlich")) : f(m).line1.minLength.$invalid ? (v(), k("span", Te, "Adresse muss mindestens 5 Zeichen haben")) : q("", !0)
            ])) : q("", !0)
          ]),
          o("div", null, [
            o("label", {
            ...
            R(o("input", {
              type: "text",
              id: "line2",
              "onUpdate:modelValue": a[3] || (a[3] = (y) => c.value.line2 = y),
              class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            }, null, 512), [
              [V, c.value.line2]
            ])
          ...
          o("div", Ne, [
            o("div", null, [
              ...
              R(o("input", {
                type: "text",
                id: "city",
                "onUpdate:modelValue": a[4] || (a[4] = (y) => c.value.city = y),
                class: S([
                  `${s.inputClass}`,
                  f(m).city.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
                ]),
                required: ""
              }, null, 2), [
                [V, c.value.city]
              ]),
              f(m).city.$error ? (v(), k("div", qe, [
                f(m).city.required.$invalid ? (v(), k("span", Le, "Stadt ist erforderlich")) : f(m).city.minLength.$invalid ? (v(), k("span", Me, "Stadt muss mindestens 2 Zeichen haben")) : q("", !0)
              ])) : q("", !0)
            ]),
            o("div", null, [
              o("label", {
              ...
              R(o("input", {
                type: "text",
                id: "postalCode",
                "onUpdate:modelValue": a[5] || (a[5] = (y) => c.value.postalCode = y),
                class: S([
                  `${s.inputClass}`,
                  f(m).postalCode.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
                ]),
                required: ""
              }, null, 2), [
                [V, c.value.postalCode]
              ]),
              f(m).postalCode.$error ? (v(), k("div", je, [
                f(m).postalCode.required.$invalid ? (v(), k("span", De, "PLZ ist erforderlich")) : f(m).postalCode.minLength.$invalid ? (v(), k("span", Ie, "PLZ muss mindestens 4 Zeichen haben")) : q("", !0)
              ])) : q("", !0)
            ]),
            o("div", null, [
              o("label", {
              ...
              R(o("select", {
                id: "country",
                "onUpdate:modelValue": a[6] || (a[6] = (y) => c.value.country = y),
                class: S([
                  `${s.inputClass}`,
                  f(m).country.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
                ]),
                required: ""
              }, [...a[12] || (a[12] = [
              ...
              f(m).country.$error ? (v(), k("div", Oe, [
                f(m).country.required.$invalid ? (v(), k("span", Re, "Land ist erforderlich")) : q("", !0)
              ])) : q("", !0)
            ])
          ])
        ])
  ...
  setup(s) {
    const p = ne(s.extensionId), l = ref(!1);
    return re(async () => {
      const c = await p.getUser().catch(() => null);
      c && c.paidAt && (l.value = !0);
    }), (c, L) => f(l) ? J(c.$slots, "paid", { key: 0 }) : J(c.$slots, "unpaid", { key: 1 });
  }
