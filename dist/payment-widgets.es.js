...
import { ref as m, onMounted as V, createElementBlock as s, openBlock as d, createElementVNode as t, toDisplayString as f, withDirectives as y, createCommentVNode as u, normalizeClass as b, unref as o, vModelText as g, createStaticVNode as P, vModelSelect as _, onBeforeMount as E, createVNode as N, withCtx as U } from "vue";
...
const M = { class: "rounded-xl border border-gray-200 p-4" }, O = { class: "grid grid-cols-2 gap-2" }, F = { class: "text-gray-800 font-medium" }, T = { class: "text-gray-800 font-medium text-sm" }, K = { class: "text-gray-800 font-medium" }, R = { class: "text-gray-800 font-medium" }, j = { class: "mt-6 pt-6 border-gray-200" }, J = { class: "grid grid-cols-1 gap-4" }, Y = {
    ...
    const x = async () => {
      if (await r.value.$validate(), !r.value.$error)
        try {
          ...
          }, e = await D.post("undefined/invoice", c);
          console.log("Invoice created successfully:", e.data), q(w, e.data);
        } catch (c) {
          console.error("Error creating invoice:", c);
        }
    };
    return (c, e) => (d(), s("div", M, [
      e[21] || (e[21] = t("h2", { class: "text-xl font-semibold mb-3" }, "Bestelldetails", -1)),
      t("div", O, [
        e[7] || (e[7] = t("span", { class: "text-gray-600" }, "Produkt:", -1)),
        t("span", F, f(a.productName), 1),
        e[8] || (e[8] = t("span", { class: "text-gray-600" }, "Beschreibung:", -1)),
        t("span", T, f(a.productDescription), 1),
        e[9] || (e[9] = t("span", { class: "text-gray-600" }, "Anzahl:", -1)),
        t("span", K, f(a.units), 1),
        e[10] || (e[10] = t("span", { class: "text-gray-600" }, "Preis:", -1)),
        t("span", R, f(a.amount) + " " + f(a.currency == "eur" ? "€" : a.currency.toUpperCase()), 1),
  ...
  setup(a, { emit: k }) {
    ...
    }), r = m({}), x = m(!1), c = m(""), e = m(), l = m();
    E(async () => {
      await B(n.stripeKey || ""), x.value = !0;
      try {
        const p = await D.post("undefined/create-payment-intent", {
          amount: n.amount * 100,
          currency: n.currency,
          metadata: n.metadata,
        ...
        c.value = p.data.clientSecret;
      } catch (p) {
        console.error("Failed to create payment intent:", p);
      }
    });
    async function I() {
      const p = e.value?.instance, S = e.value?.elements;
      if (p && S) {
        await S.submit();
        const { error: C } = await p.confirmPayment({
          elements: S,
          clientSecret: c.value,
          confirmParams: {
